const emailTemplates = {
  ...
  welcomeTemplate: (name, emailToken, baseUrl = 'http://localhost:2002') => {
    return {
      subject: 'Welcome to Our Dubem Car Rental Service - Please Verify Your Email',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
            ...
            <title>Welcome to Dubem Car Rental Service</title>
            <style>
        ...
        <body>
            <div class="header">
                <h1>🚗 Welcome to Dubem Car Rental Service!</h1>
            </div>
            <div class="content">
                <h2>Hello ${name}!</h2>
                <p>Thank you for signing up with Dubem Car Rental Service. We're excited to have you on board!</p>
            ...
            <div class="footer">
                <p>Best regards,<br>The Dubem Car Rental Service Team</p>
      ...
      `,
      text: `
        Welcome to Dubem Car Rental Service!
        ...
        Best regards,
        The Dubem Car Rental Service Team
      `
    };
  },
  ...
  loginNotificationTemplate: (name, loginTime, ipAddress = 'Unknown', location = 'Unknown') => {
    return {
      subject: 'Login Notification - Dubem Car Rental Service',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            ...
            <div class="content">
                <h2>Hello ${name}!</h2>
                <p>You have successfully logged into your Dubem Car Rental Service account.</p>
            ...
            <div class="footer">
                <p>Best regards,<br>The Dubem Car Rental Service Security Team</p>
            </div>
        </body>
        </html>
      `,
      text: `
        Successful Login - Dubem Car Rental Service
        ...
        Best regards,
        Dubem Car Rental Service Security Team
      `
    };
  },
  ...
  forgotPasswordTemplate: (name, otp) => {
    return {
      subject: 'Password Reset Request - Dubem Car Rental Service',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            ...
            <div class="content">
                <h2>Hello ${name}!</h2>
                <p>We received a request to reset your password for your Dubem Car Rental Service account.</p>
            ...
            <div class="footer">
                <p>Best regards,<br>Dubem Car Rental Service Security Team</p>
            </div>
        </body>
        </html>
      `,
      text: `
        Password Reset Request - Dubem Car Rental Service
  ...
  passwordResetConfirmationTemplate: (name) => {
    return {
      subject: 'Password Successfully Reset - Dubem Car Rental Service',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            ...
            <div class="content">
                ...
                <div class="success-box">
                    ...
                    <p>You can now log in to your Dubem Car Rental Service account with your new password.</p>
                </div>
            ...
            <div class="footer">
                <p>Best regards,<br>Dubem Car Rental Service Team</p>
            </div>
        </body>
        </html>
      `,
      text: `
        Password Reset Successful - Dubem Car Rental Service
  ...
  emailVerificationSuccessTemplate: (name) => {
    return {
        ...
        <body>
            ...
            <div class="content">
                ...
                <div class="success-box">
                    ...
                    <p>Your Dubem Car Rental Service account is now fully activated and ready to use.</p>
                </div>
                ...
                <p>Thank you for choosing Dubem Car Rental Service. We look forward to serving you!</p>
            </div>
            <div class="footer">
                <p>Best regards,<br>Dubem Car Rental Service Team</p>
            </div>
      ...
      text: `
        ...
        Thank you for choosing Dubem Car Rental Service!
  ...
  googleWelcomeTemplate: (name) => {
    return {
      subject: 'Welcome to Dubem Car Rental Service - Google Account Connected!',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
  ...
  passwordSetConfirmationTemplate: (name) => {
    return {
      subject: 'Password Added Successfully - Dubem Car Rental Service',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
